...
SIDE3 NUMBER:=&SIDE3;
BEGIN
 IF(SIDE1+SIDE2>SIDE3) AND(SIDE2+SIDE3>SIDE2) AND(SIDE1+SIDE3>SIDE2) AND
...
DECLARE
TOTAL_UNIT NUMBER:=&UNITS;
BEGIN

IF TOTAL_UNIT<=50 THEN
 CHARGE_FOR_SINGLEUNIT<=0.50
